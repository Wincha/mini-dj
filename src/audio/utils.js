...
export class BeatDetect {
  ...
  tapBpm(options) {
    ...
    const handler = this._tapBpm.bind(this, options);
    options.element.addEventListener('click', handler, false);
    return () => {
      options.element.removeEventListener('click', handler, false);
    };
  }
